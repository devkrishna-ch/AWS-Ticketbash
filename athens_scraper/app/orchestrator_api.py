...
# # ── Orchestrator / UiPath creds & IDs ─────────────────────────────
# client_id              = os.getenv("ORCHESTRATOR_APP_ID")
# client_secret          = os.getenv("ORCHESTRATOR_APP_SECRET")
# ACCOUNT_NAME           = os.getenv("ACCOUNT_NAME")
# TENANT_NAME            = os.getenv("TENANT_NAME")
# organization_unit_id   = os.getenv("ORGANIZATION_UNIT_ID")
# bucket_id              = os.getenv("BUCKET_ID")

# queue_name = {
#     "lister":  os.getenv("LISTER_QUEUE_NAME",  "ListerEventQueue"),
#     "checker": os.getenv("CHECKER_QUEUE_NAME", "CheckerEventQueue"),
# }
# orchestrator_url = f"https://cloud.uipath.com/{ACCOUNT_NAME}/{TENANT_NAME}"
...
def upload_json_content_to_bucket(access_token, bucket_name, json_content, file_name):
    ...
    print(f"Write URI fetched")
    # Convert JSON content to bytes and upload
    compact_json = json.dumps(event_data, separators=(',', ':'))
    print(f"Uploadinng JSON to bucket: {bucket_name}, file name: {file_name}")
