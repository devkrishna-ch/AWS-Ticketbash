...
EMAIL_USER = os.environ.get('EMAIL_USER', 'listerbot@ticketbash.com')
EMAIL_PASS = os.environ.get('EMAIL_PASS', '')  # App password or real SMTP password
FROM_NAME = os.environ.get('FROM_NAME', 'listerbot')  # Optional display name
