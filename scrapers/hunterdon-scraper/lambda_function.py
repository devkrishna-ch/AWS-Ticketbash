...
from hunterdon_scraper import scrape_event
...
def save_eventData_to_db(response_body: str) -> None:
    ...
    logger.info("saved hunterdon_Events event_data sample: %s", rows[:1])
...
def lambda_handler(event, context):
    ...
    engine = None
    venue_name = "Hunterdon Hills Playhouse"
    evt_name = ""
    evt_date = ""
    evt_time = ""
    process = ""
    ...
    try:
        ...
        venue_name = body.get("venue_name", "Hunterdon Hills Playhouse")
        ...
        try:
            hunterdon_Events = scrape_event(event_url, event_unique_id, venue_name)
            try:
                out = json.loads(hunterdon_Events)
            except json.JSONDecodeError:
                out = ast.literal_eval(hunterdon_Events)
        ...
        payload = {
            ...
            "venue_name": body.get("venue_name", "Hunterdon Hills Playhouse"),  # Get venue name with default
...
if __name__ == "__main__":
 event = {
        "parsed": {
                "event_unique_id": "11594367",
                "process_name": "checker",
                "event_id": "5947068",
                "venue_id": "16331",
                "event_name": "Come From Away",
                "event_datetime": "2025-10-19 14:00:00",
                "event_url": "https://ci.ovationtix.com/33425/performance/11594367"
        } }  
